...
sqoop export --connect jdbc:mysql://localhost/q11 --username root --password 'root' --table ques11 --update-mode allowinsert  --export-dir /niit/h1b10/p* --input-fields-terminated-by '\t';
